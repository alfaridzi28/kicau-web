          ...
          <div className="flex flex-wrap items-center gap-4">
             <div className="relative group">
                ...
                <input 
                  ...
                  className="bg-slate-800/40 border border-white/5 rounded-[24px] py-4 pl-14 pr-8 text-sm text-white focus:outline-none focus:border-purple-500/50 w-72 md:w-96 transition-all shadow-inner backdrop-blur-md"
                  value={search}
